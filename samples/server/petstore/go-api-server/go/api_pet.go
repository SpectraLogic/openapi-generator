...
func (c *PetAPIController) FilterPetsByCategory(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		c.errorHandler(w, r, &ParsingError{Param: "species", Err: err}, nil)
		return
	}
...
func (c *PetAPIController) FindPetsByStatus(w http.ResponseWriter, r *http.Request) {
	...
	inlineEnumPathParam := getPointerOrNilIfEmpty(params["inlineEnumPath"])
	...
	defaultIntParam, err := parseNumericParameter[int32](
		query.Get("defaultInt"),
		WithDefaultOrParse[int32](1, parseInt32),
	)
	if err != nil {
		c.errorHandler(w, r, &ParsingError{Param: "defaultInt", Err: err}, nil)
		return
	}
	defaultNumParam, err := parseNumericParameter[float32](
		query.Get("defaultNum"),
		WithDefaultOrParse[float32](1.5, parseFloat32),
	)
	if err != nil {
